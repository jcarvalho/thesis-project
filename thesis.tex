...
``Concurrent execution should not cause application programs to
malfunction''. This sentence is called the First Law of Concurrency
Control \cite{reuter1993transaction}.
...
\subsubsection{Workflows as Long-Running Activities}
