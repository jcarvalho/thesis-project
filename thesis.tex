...
languages. For Java, there is the Java Persistence API (JPA), which
provides an annotation-based API for managing persistent objects. The
most well-known implementations of the JPA are Hibernate, DataNucleus,
OpenJPA, EJB (Entreprise Java Beans), among many others.
...
of this writing, all the examples shown above operate this way.

blah

I will now take a look at how the Java Persistence API and Hibernate
attempt to cope with Long-Lived Transactions.
