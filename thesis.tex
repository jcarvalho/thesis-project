...
In such systems, it is common to provide transactional guarantees to the process
execution. Note that in this context, there is a clear separation
between {\it Business Transaction} and {\it System Transaction}. In
this case, the {\it Business Transaction} is the process as a whole,
which may be executed via several {\it System Transactions}.
...
In this document I will use an abstract model
to describe Workflow Processes, using the following concepts:
\begin{itemize}
...
support systems, such as Long-Lived Transaction support. Much research
has been made in this area to support Long-Lived Transactions, and I
will now analyse that research.

\subsubsection{Sagas}

\subsubsection{Exception Handling Systems}
